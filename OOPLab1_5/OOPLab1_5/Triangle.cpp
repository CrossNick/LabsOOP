...
void Triangle::initVector(vector<Triangle> &v, const int n)
{

	for (int i = 0; i < n; ++i) {

		float angleA, angleB, base;
		std::cout << "Input angkeA angleB base: ";
		std::cin >> angleA >> angleB >> base;
		try {
